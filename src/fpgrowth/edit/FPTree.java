...
public class FPTree {
    ...
    public void addTransaction(List<Integer> transaction) {
        ...
        Comparator<FPNode> comparator = new Comparator<FPNode>() {
            @Override
            public int compare(FPNode left, FPNode right) {
                return left.itemID - right.itemID; // use your logic
            }
        };
        ...
        for (Integer item : transaction) {
            ...
            if (child == null) {
                ...
                Collections.sort(currentNode.childs, comparator);
                
//                int index = currentNode.childs.size();
//                if (index != 0) {
//                    for (int i = 0; i < index; i++) {
//                        for (int j = i; j < index; j++) {
//                            if (currentNode.childs.get(i).itemID > currentNode.childs.get(j).itemID) {
//                                FPNode temp = currentNode.childs.get(i);
//                                currentNode.childs.set(i, currentNode.childs.get(j));
//                                currentNode.childs.set(j, temp);
//                            }
//                        }
//                    }
//                }
